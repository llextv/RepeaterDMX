...
**DMX512** is a protocol used to control lighting equipment such as moving heads, LED bars, dimmers and lasers.

A DMX universe can contain up to **512 channels**. Each channel has a value between `0` and `255`.
...
For example, an RGB light may use three channels:
...
A moving head usually uses more channels. For example:
...
The channel layout depends on the fixture and the DMX mode selected.